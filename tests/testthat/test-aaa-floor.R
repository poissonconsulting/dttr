...
test_that("floor.Date", {
  ...
  expect_identical(dtt_floor(as.Date(c("1991-02-02", "1991-03-03")), "years"),
                   as.Date(c("1991-01-01", "1991-01-01")))
  expect_identical(dtt_floor(as.Date(c("1992-01-01", "1991-02-02", "1991-03-03")), "years"),
                   as.Date(c("1992-01-01", "1991-01-01", "1991-01-01")))
  expect_identical(dtt_floor(as.Date(c("1992-01-01", "1991-02-02", NA_Date_)), "years"),
                   as.Date(c("1992-01-01", "1991-01-01", NA_Date_)))
  expect_identical(dtt_floor(as.Date(c(NA, "1992-01-01", "1991-02-02")), "years"),
                   c(NA_Date_, as.Date(c("1992-01-01", "1991-01-01"))))
  expect_identical(dtt_floor(as.Date(c(NA, "1992-01-01", NA, "1991-02-02")), "years"),
...
test_that("floor.POSXIct", {
  ...
  expect_identical(as.double(dtt_floor(as.POSIXct(1.99, origin = as.POSIXct("1970-01-01", tz = "GMT")))), 1)
  
  expect_identical(as.double(as.POSIXct(-1.99, origin = as.POSIXct("1970-01-01", tz = "GMT"))), -1.99)
  expect_identical(as.POSIXct(-1.99, origin = as.POSIXct("1970-01-01", tz = "GMT"), tz = "GMT"), 
                   as.POSIXct("1969-12-31 23:59:59", tz = "GMT") - 0.99)
  expect_identical(as.double(dtt_floor(as.POSIXct(-1.99, origin = as.POSIXct("1970-01-01", tz = "GMT")))), -1)
  
  expect_identical(dtt_floor(as.POSIXct("1969-01-01 23:59:59", tz = "UTC")), 
                   as.POSIXct("1969-01-01 23:59:59", tz = "UTC"))
  expect_identical(dtt_floor(as.POSIXct("1969-01-01 23:59:59", tz = "UTC"), "minutes"), 
                   as.POSIXct("1969-01-01 23:59:00", tz = "UTC"))
  expect_identical(dtt_floor(as.POSIXct("1969-01-01 23:59:59", tz = "UTC"), "hours"), 
                   as.POSIXct("1969-01-01 23:00:00", tz = "UTC"))
  expect_identical(dtt_floor(as.POSIXct(c("1969-01-01 23:59:59", "1969-01-01 01:02:03"), tz = "UTC"), "hours"), 
                   as.POSIXct(c("1969-01-01 23:00:00", "1969-01-01 01:00:00"), tz = "UTC"))
  expect_identical(dtt_floor(as.POSIXct(c("1969-01-01 23:59:59", NA), tz = "UTC"), "hours"), 
                   as.POSIXct(c("1969-01-01 23:00:00", NA), tz = "UTC"))
  expect_identical(dtt_floor(as.POSIXct(c("1969-12-12 23:59:59", NA), tz = "UTC"), "years"), 
