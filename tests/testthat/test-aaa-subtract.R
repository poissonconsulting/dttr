...
test_that("subtract_years.Date", {
  ...
  expect_identical(dtt_subtract_years(as.Date("2000-01-01"), 0L), as.Date("2000-01-01"))
  expect_identical(dtt_subtract_years(as.Date("2000-01-01"), 2L), as.Date("1998-01-01"))
  expect_identical(dtt_subtract_years(as.Date(c("2000-01-01", "2002-01-01")), 2L), 
                   as.Date(c("1998-01-01", "2000-01-01")))

  expect_identical(dtt_subtract_years(as.Date(c("2000-01-01", "2002-01-01")), 2:3), 
                   as.Date(c("1998-01-01", "1999-01-01")))

  expect_identical(dtt_subtract_years(c(as.Date("2002-01-01"),NA), 3L), 
...
test_that("subtract_years.POSIXct", {
  ...
  expect_identical(dtt_subtract_years(as.POSIXct("2000-01-01", tz = "UTC"), 0L), 
                   as.POSIXct("2000-01-01", tz = "UTC"))
  expect_identical(dtt_subtract_years(as.POSIXct("2000-01-01", tz = "UTC"), 2L), 
                   as.POSIXct("1998-01-01", tz = "UTC"))
  expect_identical(dtt_subtract_years(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2L), 
                   as.POSIXct(c("1998-01-01", "2000-01-01"), tz = "UTC"))

  expect_identical(dtt_subtract_years(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3), 
                   as.POSIXct(c("1998-01-01", "1999-01-01"), tz = "UTC"))

  expect_identical(dtt_subtract_years(c(as.POSIXct("2002-01-01", tz = "UTC"),NA), 3L), 
                   c(as.POSIXct("1999-01-01", tz = "UTC"), NA))
  expect_identical(dtt_subtract_years(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"),NA), -3L), 
...
test_that("subtract_months.Date", {
  ...
  expect_identical(dtt_subtract_months(as.Date("2000-01-01"), 0L), as.Date("2000-01-01"))
  expect_identical(dtt_subtract_months(as.Date("2000-01-01"), 2L), as.Date("1999-11-01"))
  expect_identical(dtt_subtract_months(as.Date(c("2000-01-01", "2002-01-01")), 2L), 
                   as.Date(c("1999-11-01", "2001-11-01")))

  expect_identical(dtt_subtract_months(as.Date(c("2000-01-01", "2002-01-01")), 2:3), 
                   as.Date(c("1999-11-01", "2001-10-01")))

  expect_identical(dtt_subtract_months(c(as.Date("2002-01-01"),NA), 3L), 
...
test_that("subtract_months.POSIXct", {
  ...
  expect_identical(dtt_subtract_months(as.POSIXct("2000-01-01", tz = "UTC"), 0L), 
                   as.POSIXct("2000-01-01", tz = "UTC"))
  expect_identical(dtt_subtract_months(as.POSIXct("2000-01-01", tz = "UTC"), 2L), 
                   as.POSIXct("1999-11-01", tz = "UTC"))
  expect_identical(dtt_subtract_months(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2L), 
                   as.POSIXct(c("1999-11-01", "2001-11-01"), tz = "UTC"))

  expect_identical(dtt_subtract_months(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3), 
                   as.POSIXct(c("1999-11-01", "2001-10-01"), tz = "UTC"))

  expect_identical(dtt_subtract_months(c(as.POSIXct("2002-01-01", tz = "UTC"),NA), 3L), 
                   c(as.POSIXct("2001-10-01", tz = "UTC"), NA))
  expect_identical(dtt_subtract_months(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"),NA), -3L), 
...
test_that("subtract_days.Date", {
  ...
  expect_identical(dtt_subtract_days(as.Date("2000-01-01"), 0L), as.Date("2000-01-01"))
  expect_identical(dtt_subtract_days(as.Date("2000-01-01"), 2L), as.Date("1999-12-30"))
  expect_identical(dtt_subtract_days(as.Date(c("2000-01-01", "2002-01-02")), 2L), 
                   as.Date(c("1999-12-30", "2001-12-31")))

  expect_identical(dtt_subtract_days(as.Date(c("2000-01-01", "2002-01-02")), 2:3), 
                   as.Date(c("1999-12-30", "2001-12-30")))

  expect_identical(dtt_subtract_days(c(as.Date("2002-01-01"),NA), 3L), 
...
test_that("subtract_days.POSIXct", {
  ...
  expect_identical(dtt_subtract_days(as.POSIXct("2000-01-01", tz = "UTC"), 0L), 
                   as.POSIXct("2000-01-01", tz = "UTC"))
  expect_identical(dtt_subtract_days(as.POSIXct("2000-01-01", tz = "UTC"), 2L), 
                   as.POSIXct("1999-12-30", tz = "UTC"))
  expect_identical(dtt_subtract_days(as.POSIXct(c("2000-01-01", "2002-01-02"), tz = "UTC"), 2L), 
                   as.POSIXct(c("1999-12-30", "2001-12-31"), tz = "UTC"))

  expect_identical(dtt_subtract_days(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3), 
                   as.POSIXct(c("1999-12-30", "2001-12-29"), tz = "UTC"))

  expect_identical(dtt_subtract_days(c(as.POSIXct("2002-01-01", tz = "UTC"),NA), 3L), 
                   c(as.POSIXct("2001-12-29", tz = "UTC"), NA))
  expect_identical(dtt_subtract_days(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"),NA), -3L), 
...
test_that("subtract_hours.POSIXct", {
  ...
  expect_identical(dtt_subtract_hours(as.POSIXct("2000-01-01", tz = "UTC"), 0L), 
                   as.POSIXct("2000-01-01", tz = "UTC"))
  expect_identical(dtt_subtract_hours(as.POSIXct("2000-01-01", tz = "UTC"), 2L), 
                   as.POSIXct("1999-12-31 22:00:00", tz = "UTC"))
  expect_identical(dtt_subtract_hours(as.POSIXct(c("2000-01-01", "2002-01-02"), tz = "UTC"), 2L), 
                   as.POSIXct(c("1999-12-31 22:00:00", "2002-01-01 22:00:00"), tz = "UTC"))

  expect_identical(dtt_subtract_hours(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3), 
                   as.POSIXct(c("1999-12-31 22:00:00", "2001-12-31 21:00:00"), tz = "UTC"))

  expect_identical(dtt_subtract_hours(c(as.POSIXct("2002-01-01", tz = "UTC"),NA), 3L), 
                   c(as.POSIXct("2001-12-31 21:00:00", tz = "UTC"), NA))
  expect_identical(dtt_subtract_hours(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"),NA), -3L), 
...
test_that("subtract_hours.hms", {
  ...
  expect_identical(dtt_subtract_hours(hms::as_hms("00:00:00"), 0L), 
                   hms::as_hms("00:00:00"))
